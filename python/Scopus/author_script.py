...
def author_overcites(link, name, num, sortType='relevance'):
    auth = AcademicPublisher(SessionInitializer.ROOT_URL + link, 1, loadPaperPDFs=False, sortType=sortType)
...
author_overcites('/citations?user=_yWPQWoAAAAJ&hl=en&oi=ao', 'vasilakos', 50, sortType='date')
